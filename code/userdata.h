...
IPAddress ip(192,168,1,100);                                                    // IP address
IPAddress dns(8,8,8,8);                                                         // DNS server
IPAddress gateway(10,10,20,1);                                                  // Gateway
IPAddress subnet(255,255,255,0);                                                // Subnet mask

#define DEVICE_HOSTNAME "device_hostname"                                       // Hostname

//************* CONFIG MQTT ******************************************************************************
// Configurations of your MQTT server -
//********************************************************************************************************
const char* MQTT_SERVER = "192.168.1.107";                                      // MQTT server IP ou URL
...
//********************************************************************************************************
  const char* MQTT_WILL_TOPIC = "topic/status";                                 // MQTT last will topic
...
//********************************************************************************************************
const char* mqtt_topic_watt = "device/watt";                                    // MQTT topic - watt
const char* mqtt_topic_kwh = "device/kwh";                                      // MQTT topic - kwh
const char* mqtt_topic_pulse = "device/pulse";                                  // MQTT topic - pulse
const char* mqtt_topic_ip = "device/ip";                                        // MQTT topic - ip
const char* mqtt_topic_mac = "device/mac";                                      // MQTT topic - mac
